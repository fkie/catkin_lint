...
class LinterTest(unittest.TestCase):
    ...
    def test_report_path(self):
        ...
        self.assertEqual(info.report_path("%s/test" % PathConstants.PACKAGE_BINARY), "${PROJECT_BINARY_DIR}/test")
        self.assertEqual(info.report_path("%s/%s/test" % (PathConstants.PACKAGE_SOURCE, PathConstants.PACKAGE_BINARY)), "${PROJECT_SOURCE_DIR}/${PROJECT_BINARY_DIR}/test")
        self.assertEqual(info.report_path("%s/%s/test" % (PathConstants.PACKAGE_BINARY, PathConstants.PACKAGE_SOURCE)), "${PROJECT_BINARY_DIR}/${PROJECT_SOURCE_DIR}/test")
        ...
        self.assertEqual(info.report_path("%s//test" % PathConstants.PACKAGE_BINARY), "${PROJECT_BINARY_DIR}/test")
        self.assertEqual(info.report_path("%s/bar/../foo" % PathConstants.PACKAGE_BINARY), "${PROJECT_BINARY_DIR}/foo")
        self.assertEqual(info.report_path("%s/../test" % PathConstants.PACKAGE_BINARY), "${PROJECT_BINARY_DIR}/../test")
        self.assertEqual(info.report_path("%s/../test" % PathConstants.PACKAGE_BINARY), "${PROJECT_BINARY_DIR}/../test")
        self.assertEqual(info.report_path("//%s%s/bar/../foo" % (PathConstants.CATKIN_DEVEL, PathConstants.PACKAGE_BINARY)), "/${CATKIN_DEVEL_PREFIX}${PROJECT_BINARY_DIR}/foo")
